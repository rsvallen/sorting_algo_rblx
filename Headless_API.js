...
console.log("Custom loaded.")(function (va) {
		...
		static ri(a, b) {
			try {
				...
				return ra
					.ui(g, k)
					.then(function (t) {
						return window.crypto.subtle.verify(ra.ci, t, e, d);
					})
					.then(function (t) {
						if (!t) throw r.s(null);
						return g;
	...
	class E {
		static sh() {
			...
			fa.Sg()
				...
				.then(function () {
					window.parent.HBInit = E.fi;
					let a = window.parent.onHBLoaded;
					null != a && a();
				});
			E.Vh = window.document.getElementById("roomlink");
		}
		static bi(a, b, c) {
			null == E.bd &&
				((E.bd = window.document.getElementById("recaptcha")),
				(E.Ph = a.render(E.bd, {
					sitekey: b,
					callback: function (d) {
						null != E.Td && E.Td(d);
	...
	class w {
		...
		oi(a) {
			...
			c = a.C();
			for (d = 0; d < c; )
				++d, (e = new G()), e.pa(a, this.v), this.I.push(e);
			this.Y = [];
			c = a.C();
					...
					if (((t = q.l(x, Array)), null != t))
						for (x = 0; x < t.length; ) {
							...
							try {
								...
								throw r.s(
									new Ia('Error in "' + l + '" index: ' + k.length)
								);
							}
						}
			}
	...
	class cb {
		constructor(a) {
			...
			this.Rb = a.Rb;
			this.hb = a.hb;
			this.Nf = window.performance.now();
			let b = null,
				c = this;
			b = function () {
				var e = c.Qh - c.ki();
			...
			for (; a < d.length; ) {
				...
				e.onmessage = function (f) {
					c.Lc &&
						((c.Nf = window.performance.now()),
						null != c.nf && c.nf(f.data));
				};
				e.onclose = function () {
					c.cb();
				};
		...
		ki() {
			return window.performance.now() - this.Nf;
		}
		ob(a, b) {
						...
						? (this.j.setUint8(b + 2, (a >> 14) | 128),
						  2097152 <= a
								? (this.j.setUint8(b + 3, (a >> 21) | 128),
								  268435456 <= a
										? (this.j.setUint8(b + 4, (a >> 28) & 127),
										  (a = 5))
										: (this.j.setUint8(
												b + 3,
												this.j.getUint8(b + 3) & 127
										  ),
										  (a = 4)))
	...
	class Ka {
		...
		Yd(a) {
			...
			this.lc = a;
			let c = this;
			null == this.Af && (b(), (this.Af = window.setTimeout(b, 1e3)));
		}
		$d(a) {
			function b(e) {
				e = e.sitekey;
		...
		bh() {
			...
			0 != this.lc && this.Cf();
			let a = this;
			this.Dh = window.setInterval(function () {
				a.Yh();
			}, 4e4);
		}
		ah(a) {
		...
		Ed(a) {
			this.Lg();
			window.clearTimeout(this.fd);
			this.fd = null;
			this.ed = !1;
			window.clearInterval(this.Dh);
			window.clearTimeout(this.Uh);
			let b = this;
			a &&
				(this.Uh = window.setTimeout(function () {
					b.$d();
				...
				default:
					if (null != a)
						if ("function" == typeof b) {
							...
							if ("object" == typeof b && q.ng(b) && a instanceof b)
								return !0;
						}
					else return !1;
	...
	class ta {
		...
		gi() {
			...
			this.be = window.setTimeout(hb(this, this.dh), a);
		}
		async Gg(a, b) {
	...
	class Ua {
		constructor(a, b) {
			...
			this.Pf = b;
			this.tb = a;
			this.Qc = window.performance.now();
		}
		Qf() {
			var a;
			null == a && (a = 1);
			...
			if (0 < this.Xa) 120 > this.Xa && this.Xa--;
				...
				if (0 == this.$a) {
					...
					for (
						...
						a < c &&
						((d = a++),
						(d = this.ea.Ag(b[Q.Re[d]].a, Q.jf[d])),
						d == u.na);
					...
					this.Ab--,
						0 >= this.Ab &&
							((0 < this.ab &&
								(this.zb >= this.ab || this.vb >= this.ab)) ||
							(0 < this.Na &&
								this.Lb >= 60 * this.Na &&
								this.zb != this.vb)
								? this.If()
	...
	class Pa extends La {
		...
		Aa(a) {
			...
			this.wh = 1;
			this.bf = 0;
			this.Kf = window.performance.now();
		...
		Ba() {
			let a =
				(((window.performance.now() - this.Kf) * this.Ae) | 0) - this.da;
			0 < a && this.rg(a);
		...
		Kh(a, b) {
			...
			a = A.aa();
			a.f(4);
			a.g((window.performance.now() - this.Kf) * this.Ae + this.Qb);
			a.g(c);
			b.ob(a, 2);
		}
		Mh(a, b) {
	...
	class U extends m {
		...
		W(a) {
			...
			this.td = w.pa(
				new M(new DataView(a.buffer, a.byteOffset, a.byteLength))
			);
		}
		static V(a) {
			let b = new U();
	...
	class za extends m {
		...
		apply(a) {
			...
			if (null != b) {
				...
				null != a.uf &&
					null != b.N &&
					a.uf(b, this.input, this.eg, this.fg);
			}
		}
		P(a) {
			a.xa(this.input);
	...
	class R extends m {
		...
		W(a) {
			...
			this.rb = a.Ya();
			this.od = 0 != a.C();
			if (null != this.rb && 100 < this.rb.length)
				throw r.s("string too long");
		}
		static V(a, b, c) {
			let d = new R();
			d.ma = a;
